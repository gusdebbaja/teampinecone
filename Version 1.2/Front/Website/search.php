...
?>
<h2 class="col-sm-6 col-sm-offset-3">#<?php echo $theHashtag?>   has been used <?php echo $uses?> times!</h2> <br>
                ...
                <h3>
                    <a>----------------------------Leaderboard----------------------------</a>
                        ...
                        <li class="list-group-item">
                            <span class="badge"><?php echo $uses?>pts</span>
                                #<?php echo $theHashtag?>
                        </li>
                    </ul>
